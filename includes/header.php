            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if (isset($_SESSION['usuario'])): ?>
                        ...
                        <?php if (isset($_SESSION['usuario']['tipo_usuario']) && $_SESSION['usuario']['tipo_usuario'] == 'admin'): ?>
                            <li class="nav-item"><a class="nav-link" href="../views/usuario_gestion.php">Gestión de Usuarios</a></li>
                            <li class="nav-item"><a class="nav-link" href="../views/evento_gestion.php">Gestión de Eventos</a></li>
                            <li class="nav-item"><a class="nav-link" href="../views/contacto_gestion.php">Gestión de Contactos</a></li>
                        <?php endif; ?>
